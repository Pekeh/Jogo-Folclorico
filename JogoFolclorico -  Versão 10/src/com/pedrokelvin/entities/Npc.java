...
public class Npc extends Entity{
	...
	public Npc(int x, int y, int width, int height, BufferedImage sprite) {
		...
		frases[0] = "Olá, eu sou curupira, bem vindo ao jogo!";
		frases[1] = "Movimentação é dada através das teclas W,A,S,D ou das SETAS DIRECIONAIS";
		frases[2] = "Ataque os inigos com o MOUSE ou com a tecla J";
		frases[3] = "Os coletaveis no mapa representam a REGENERAÇÃO DE VIDA e MUNIÇÃO";
		frases[4] = "Você pode acessar os recursos do seu inventário através dos botões 1,2,3 e 4";
		frases[5] = "Use a BARRA DE ESPAÇO para salvar a sua fase em progresso";
		frases[6] = "Divirta-se e aproveite o conteudo";
	}
