...
public class Tile {
	...
	public static BufferedImage TILE_PASS2 = Game.spritesheet.getSprite(192,384,32,32);
	public static BufferedImage TILE_PASS3 = Game.spritesheet.getSprite(224,384,32,32);
