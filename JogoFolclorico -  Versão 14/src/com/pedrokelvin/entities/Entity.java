...
public class Entity {
	...
	public static BufferedImage PERGAMINHO_EN = Game.spritesheet.getSprite(292,611,25,25);
	...
	public static BufferedImage MAPINGUARI_EN = Game.spritesheet.getSprite(0,640,32,32);
	public static BufferedImage MAPINGUARI_FEEDBACK = Game.spritesheet.getSprite(128,640,32,32);
	...
	public static BufferedImage MULA_EN = Game.spritesheet.getSprite(0, 1184, 39, 32);
	public static BufferedImage MULA_FEEDBACK_LEFT = Game.spritesheet.getSprite(162, 1184, 37, 32);
	public static BufferedImage MULA_FEEDBACK_RIGHT = Game.spritesheet.getSprite(162, 1216, 37, 32);
	public static BufferedImage DOLPHIN_RIGHT = Game.spritesheet.getSprite(0, 832, 32, 32);
	public static BufferedImage DOLPHIN_LEFT = Game.spritesheet.getSprite(64, 832, 32, 32);
	public static BufferedImage DOLPHIN_FEEDBACK_RIGHT = Game.spritesheet.getSprite(128, 832, 32, 32);
	public static BufferedImage DOLPHIN_FEEDBACK_LEFT = Game.spritesheet.getSprite(160, 832, 32, 32);
	public static BufferedImage DOLPHIN_WATER = Game.spritesheet.getSprite(160,320,32,32);
	public static BufferedImage NPC = Game.spritesheet.getSprite(64, 288, 32, 32);
	public static BufferedImage SACI = Game.spritesheet.getSprite(128, 768, 32, 32);
	public static BufferedImage BOITATA = Game.spritesheet.getSprite(32, 768, 32, 32);
	public static BufferedImage BOITATA_FEEDBACK = Game.spritesheet.getSprite(96, 768, 32, 32);
	public static BufferedImage CAPELOBO = Game.spritesheet.getSprite(0, 800, 32, 32);
	public static BufferedImage CAPELOBO_FEEDBACK = Game.spritesheet.getSprite(128, 800, 32, 32);
	public static BufferedImage CUCA = Game.spritesheet.getSprite(64, 864, 64, 64);
