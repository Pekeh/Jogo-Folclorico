...
public class Pergaminho extends Entity{
	...
	public Pergaminho(int x, int y, int width, int height, BufferedImage sprite) {
		...
		titulos[4] = "CAPELOBO";
		frases[4] = "Possui cabeça de tamanduá-bandeira, \n"
		...
		titulos[5]= "BOTO ROSA";
		frases[5] = " O boto cor-de-rosa sai dos rios nas\n"
		...
		titulos[6]= "IARA";
		frases[6]= "A Iara é um ser, metade peixe metade\n"
	...
	public void tick() {
		...
		else if(Game.CUR_LEVEL==16) {
			fraseIndex=6;
		}
		else if(Game.CUR_LEVEL==19) {
			fraseIndex=7;
		}
