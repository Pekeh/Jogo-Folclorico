...
public class Menu {
	...
	public void tick() {
		if(banner==null) {
			try {
				banner = ImageIO.read(getClass().getResourceAsStream("/banner.png"));
			}catch(IOException e) {
				e.printStackTrace();
			}
		}
	...
	public void render(Graphics g) {
		...
		if(Game.estado_cena==Game.jogando) {
			...
			g2.drawImage(banner,0,0, Toolkit.getDefaultToolkit().getScreenSize().width, Toolkit.getDefaultToolkit().getScreenSize().height, null);
