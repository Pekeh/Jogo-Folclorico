...
public class Entity {
	public static BufferedImage LIFEPACK_EN = Game.spritesheet.getSprite(6,296,19,16);
	...
	public static BufferedImage BULLET_EN = Game.spritesheet.getSprite(43,290,10,29);
	...
	public static BufferedImage IARA_FRONT = Game.spritesheet.getSprite(96, 416, 32, 32);
	public static BufferedImage IARA_RIGHT = Game.spritesheet.getSprite(32, 416, 32, 32);
	public static BufferedImage IARA_LEFT = Game.spritesheet.getSprite(64, 416, 32, 32);
	public static BufferedImage IARA_BACK = Game.spritesheet.getSprite(0, 416, 32, 32);
