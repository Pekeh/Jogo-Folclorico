		...
		try {
			...
			for(int xx = 0; xx<map.getWidth(); xx++) {
				for(int yy = 0; yy<map.getWidth(); yy++) {
					...
					if(Game.CUR_LEVEL==1 || Game.CUR_LEVEL==2 || Game.CUR_LEVEL==3  || Game.CUR_LEVEL==4 || Game.CUR_LEVEL==5 || Game.CUR_LEVEL==13)
					...
					if(pixelAtual == 0xFF000000) {
						...
						//Parede
						if(Game.CUR_LEVEL==1 || Game.CUR_LEVEL==2 || Game.CUR_LEVEL==3  || Game.CUR_LEVEL==4 || Game.CUR_LEVEL==5 ||
								Game.CUR_LEVEL==13)
						...
						else  if(Game.CUR_LEVEL==6 || Game.CUR_LEVEL==7 || Game.CUR_LEVEL==8 || Game.CUR_LEVEL==9 || Game.CUR_LEVEL==10)
						...
						//Borda Agua EC
						tiles[xx + (yy*WIDTH)] = new WallTile(xx*32,yy*32, Tile.TILE_BORDA_AGUA_EC);
					}
					else if(pixelAtual == 0xFF001DB2){
						//Borda Agua DC
						tiles[xx + (yy*WIDTH)] = new WallTile(xx*32,yy*32, Tile.TILE_BORDA_AGUA_DC);
					}
					else if(pixelAtual == 0xFF001DB3){
						//Borda Agua C
						tiles[xx + (yy*WIDTH)] = new WallTile(xx*32,yy*32, Tile.TILE_BORDA_AGUA_C);
					}
					else if(pixelAtual == 0xFF001DB4){
						//Borda Agua B
						tiles[xx + (yy*WIDTH)] = new WallTile(xx*32,yy*32, Tile.TILE_BORDA_AGUA_B);
					}
					else if(pixelAtual == 0xFF001DB5){
						//Borda Agua EB
						tiles[xx + (yy*WIDTH)] = new WallTile(xx*32,yy*32, Tile.TILE_BORDA_AGUA_EB);
					}
					else if(pixelAtual == 0xFF001DB6){
						//Borda Agua DB
						tiles[xx + (yy*WIDTH)] = new WallTile(xx*32,yy*32, Tile.TILE_BORDA_AGUA_DB);
					}
					else if(pixelAtual == 0xFF001DB7){
						//Borda Agua D
						tiles[xx + (yy*WIDTH)] = new WallTile(xx*32,yy*32, Tile.TILE_BORDA_AGUA_D);
					}
					else if(pixelAtual == 0xFF001DB8){
						//Borda Agua E
						tiles[xx + (yy*WIDTH)] = new WallTile(xx*32,yy*32, Tile.TILE_BORDA_AGUA_E);
					}
					else if(pixelAtual == 0xFF001DB9){
						//Borda Agua IEC
						tiles[xx + (yy*WIDTH)] = new WallTile(xx*32,yy*32, Tile.TILE_BORDA_AGUA_IEC);
					}
					else if(pixelAtual == 0xFF001DBA){
						//Borda Agua IDC
						tiles[xx + (yy*WIDTH)] = new WallTile(xx*32,yy*32, Tile.TILE_BORDA_AGUA_IDC);
					}
					else if(pixelAtual == 0xFF001DBB){
						//Borda Agua IEB
						tiles[xx + (yy*WIDTH)] = new WallTile(xx*32,yy*32, Tile.TILE_BORDA_AGUA_IEB);
					}
					else if(pixelAtual == 0xFF001DBC){
						//Borda Agua IDB
						tiles[xx + (yy*WIDTH)] = new WallTile(xx*32,yy*32, Tile.TILE_BORDA_AGUA_IDB);
					}
					...
					//CAVERNA
						...
						tiles[xx + (yy*WIDTH)] = new CenarioColTile(xx*32,yy*32, Tile.CHAO_CAVERNA);
					}
