...
public class Mula extends Entity{
		...
		public Mula(int x, int y, int width, int height, BufferedImage sprite) {
			...
			sprites[0] = Game.spritesheet.getSprite(0, 1184, 32, 32);
			sprites[1] = Game.spritesheet.getSprite(32, 1184, 32, 32);
			sprites[2] = Game.spritesheet.getSprite(64, 1184, 32, 32);
			sprites[3] = Game.spritesheet.getSprite(96, 1184, 32, 32);
			sprites[4] = Game.spritesheet.getSprite(128, 1184, 32, 32);
		}
					...
					if(this.isColiddingWithPlayer()==false) {
						...
						if(x<Game.player.getX() && World.isFree((int)(x+speed), this.getY())
							...
							instanceFire=true;
								...
								&& !isColidding((int)(x-speed), this.getY())) {
							sprites[0] = Game.spritesheet.getSprite(160, 1184, 32, 32);
							sprites[1] = Game.spritesheet.getSprite(192, 1184, 32, 32);
							sprites[2] = Game.spritesheet.getSprite(224, 1184, 32, 32);
							sprites[3] = Game.spritesheet.getSprite(256, 1184, 32, 32);
							sprites[4] = Game.spritesheet.getSprite(288, 1184, 32, 32);
							x-=speed;
							if(this.getX()%16==0) {
								FireTrail fireTrail = new FireTrail(this.getX()+32, this.getY()+8, 23, 27, null);
								Game.fireTrail.add(fireTrail);
