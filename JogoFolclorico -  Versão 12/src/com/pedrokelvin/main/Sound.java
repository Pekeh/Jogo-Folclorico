...
public class Sound {
	...
	public static final Sound iaraDamageEffect = new Sound("/sound/iaraDamage.wav");
	public static final Sound waterballEffect = new Sound("/sound/waterball.wav");
	public static final Sound mulaDamage = new Sound("/sound/mulaDamage.wav");
