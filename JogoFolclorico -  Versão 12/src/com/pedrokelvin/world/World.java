...
public class World {
		...
		try {
			...
			for(int xx = 0; xx<map.getWidth(); xx++) {
				for(int yy = 0; yy<map.getWidth(); yy++) {
					...
					if(Game.CUR_LEVEL==1 || Game.CUR_LEVEL==2 || Game.CUR_LEVEL==3 || Game.CUR_LEVEL==4)
					...
					if(pixelAtual == 0xFF000000) {
						...
						//Parede
						if(Game.CUR_LEVEL==1 || Game.CUR_LEVEL==2 || Game.CUR_LEVEL==3 || Game.CUR_LEVEL==6)
						...
						//Passagem
						if(Game.CUR_LEVEL==1 || Game.CUR_LEVEL==2 || Game.CUR_LEVEL==6)
	...
	public void render (Graphics g) {
		...
		if(Game.enemies.size()!=0){
			...
			else if(Game.CUR_LEVEL==5 || Game.CUR_LEVEL==6 || Game.CUR_LEVEL==7)
			...
			else if(Game.CUR_LEVEL==3 || Game.CUR_LEVEL==4 || Game.CUR_LEVEL==6)
				tiles[passageX + (passageY*WIDTH)] = new PassTile(passX,passY, Tile.TILE_PASS);
			else if(Game.CUR_LEVEL==5)
				tiles[passageX + (passageY*WIDTH)] = new PassTile(passX,passY, Tile.TILE_PASS);
		}
