			...
			for(int xx = 0; xx<map.getWidth(); xx++) {
				for(int yy = 0; yy<map.getWidth(); yy++) {
					...
					if(pixelAtual == 0xFF000000) {
						...
						//Cerca
						tiles[xx + (yy*WIDTH)] = new CenarioColTile(xx*32,yy*32, Tile.TILE_CERCA);
					}
					...
					//LAGO FLOOR TILES	
						...
						tiles[xx + (yy*WIDTH)] = new FloorTile(xx*32,yy*32, Tile.TILE_LAGO_DCD);
					}
					else if(pixelAtual == 0xFFFF0068){
						//Lago Cima
						tiles[xx + (yy*WIDTH)] = new FloorTile(xx*32,yy*32, Tile.TILE_LAGO_C);
					}
					else if(pixelAtual == 0xFFFF0067){
						//Lago Diagonal Cima Esquerda
						tiles[xx + (yy*WIDTH)] = new FloorTile(xx*32,yy*32, Tile.TILE_LAGO_DCE);
					}
					else if(pixelAtual == 0xFFFF0066){
						//Lago Lateral Direita
						tiles[xx + (yy*WIDTH)] = new FloorTile(xx*32,yy*32, Tile.TILE_LAGO_LD);
					}
					else if(pixelAtual == 0xFFFF0064){
						//Lago Lateral Esquerda
						tiles[xx + (yy*WIDTH)] = new FloorTile(xx*32,yy*32, Tile.TILE_LAGO_LE);
					}
					else if(pixelAtual == 0xFFFF0063){
						//Lago Diagonal Baixo Direita
						tiles[xx + (yy*WIDTH)] = new FloorTile(xx*32,yy*32, Tile.TILE_LAGO_DBD);
					}
					else if(pixelAtual == 0xFFFF0062){
						//Lago Baixo
						tiles[xx + (yy*WIDTH)] = new FloorTile(xx*32,yy*32, Tile.TILE_LAGO_B);
					}
					else if(pixelAtual == 0xFFFF0061){
						//Lago Diagonal Baixo Esquerda
						tiles[xx + (yy*WIDTH)] = new FloorTile(xx*32,yy*32, Tile.TILE_LAGO_DBE);
					}
