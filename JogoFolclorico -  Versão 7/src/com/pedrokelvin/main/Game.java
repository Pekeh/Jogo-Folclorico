	...
	public void tick() {
		...
		*/
			if(this.saveGame){
				...
				int[] opt2 = {this.CUR_LEVEL,(int)player.life-1, (int)player.ammo-1,  (int)player.mana, (int)player.loadLanca, (int)player.loadZarabatana, (int)player.loadTridente, (int)player.loadFireBall};
		...
		if(Game.player.getX() >= Game.world.passX-32
				&& Game.player.getX() <= Game.world.passX+12
				&& Game.player.getY() >= Game.world.passY-10
				&& Game.player.getY() <= Game.world.passY+12) {
			CUR_LEVEL++;
