...
import com.pedrokelvin.world.Mana;
		...
		if(!isDamaged) {
			if(dir==right_dir) {
				...
				if(zarabatanaActive) {
					...
					g.drawImage(Entity.FIRE_BALL_RIGHT, this.getX() +6 - Camera.x, this.getY()- Camera.y, null);
				}
				...
				if(zarabatanaActive) {
					...
					g.drawImage(Entity.FIRE_BALL_LEFT, this.getX() -6 - Camera.x, this.getY()- Camera.y, null);
				}
			}
			else if(dir==up_dir) {
